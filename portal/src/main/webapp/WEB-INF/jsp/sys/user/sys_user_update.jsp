...
<div>
    ...
    <div class="panel-form">
        <form id="updateForm" action="${basePath}/sysUser/update" method="post">
            <div class="row">
                ...
                <div class="cell-text"><input id="operPassword" name="operPassword" class="easyui-textbox" required="required"
                                              value="${sysUser.operPassword}" style="width:100%"></div>
            </div>
            <div class="row">
